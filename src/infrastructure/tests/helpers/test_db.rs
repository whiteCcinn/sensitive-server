use web::configuration::Config;
use diesel::connection::SimpleConnection;
use log::error;
use r2d2::{CustomizeConnection, Pool};
use sensitive_server_infrastructure::{Repo, Repository};
...
pub fn clean_db(repo: &Repository) {
    repo.0
        .conn()
        .batch_execute("DELETE FROM sensitive_regular; DELETE FROM sensitive_words;")
